...
LinkedIn profiles contain rich but highly unstructured information about individuals’ professional careers. 
...
The \textit{results\_utils.py} were created for each model to use and to add their results. 
