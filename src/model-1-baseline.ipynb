{
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        "id": "JBIzss4uostP",
        "outputId": "346abae3-85f8-4627-ad29-5925274d579c",
        "colab": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "29cqQocTolnD",
        "outputId": "697472c5-005e-4ec8-b57d-7291423d6dbd",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "HkJLjRjVvJ9B",
        "outputId": "e6cbf83d-d178-4f2a-e82c-5a5367e9644a",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 204
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-b4ea5523-0844-4d5c-9d01-a66b0ab47daa\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-b4ea5523-0844-4d5c-9d01-a66b0ab47daa')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-b4ea5523-0844-4d5c-9d01-a66b0ab47daa button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-b4ea5523-0844-4d5c-9d01-a66b0ab47daa');\n",
              "        const dataTable =\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-9a927459-6684-4374-bb8b-ac941b54f81b\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-9a927459-6684-4374-bb8b-ac941b54f81b')\"\n",
              ...
              "            document.querySelector('#df-9a927459-6684-4374-bb8b-ac941b54f81b button');\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "8rfOus18vL73",
        "outputId": "fd322c79-6c05-4230-b3a0-02abbcd15ac4",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 204
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-28741689-0866-4321-bd50-cee34120d4df\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-28741689-0866-4321-bd50-cee34120d4df')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-28741689-0866-4321-bd50-cee34120d4df button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-28741689-0866-4321-bd50-cee34120d4df');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-2f9ed2b0-3ccd-4a9f-b15b-4e598ee6d3ac\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-2f9ed2b0-3ccd-4a9f-b15b-4e598ee6d3ac')\"\n",
              "                title=\"Suggest charts\"\n",
              "                style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "        (() => {\n",
              "          let quickchartButtonEl =\n",
              "            document.querySelector('#df-2f9ed2b0-3ccd-4a9f-b15b-4e598ee6d3ac button');\n",
              "          quickchartButtonEl.style.display =\n",
              "            google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "        })();\n",
              "      </script>\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "variable_name": "seniority_df",
              "summary": "{\n  \"name\": \"seniority_df\",\n  \"rows\": 9428,\n  \"fields\": [\n    {\n      \"column\": \"text\",\n      \"properties\": {\n        \"dtype\": \"string\",\n        \"num_unique_values\": 9428,\n        \"samples\": [\n          \"VP of Sales & Marketing Division\",\n          \"Head of Service Department\",\n          \"Lead Business Analyst\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"label\",\n      \"properties\": {\n        \"dtype\": \"category\",\n        \"num_unique_values\": 5,\n        \"samples\": [\n          \"Senior\",\n          \"Director\",\n          \"Lead\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 14
    ...
    },
    {
      ...
      "metadata": {
        "id": "etka-bAGvOXT",
        "outputId": "4c3b821c-d57f-46c1-892f-3dba8cb62c23",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 204
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              "   cv_id  job_index       organization        position startDate endDate  \\\n",
              "0      0          0  Depot4Design GmbH       Prokurist   2019-08     NaN   \n",
              "1      0          1  Depot4Design GmbH             CFO   2019-07     NaN   \n",
              "2      0          2  Depot4Design GmbH  Betriebswirtin   2019-07     NaN   \n",
              "3      0          3  Depot4Design GmbH     Prokuristin   2019-07     NaN   \n",
              "4      0          4  Depot4Design GmbH             CFO   2019-07     NaN   \n",
              "\n",
              "   status department     seniority  \n",
              "0  ACTIVE      Other    Management  \n",
              "1  ACTIVE      Other    Management  \n",
              "2  ACTIVE      Other  Professional  \n",
              "3  ACTIVE      Other    Management  \n",
              "4  ACTIVE      Other    Management  "
            ],
            "text/html": [
              "\n",
              "  <div id=\"df-8ce6350f-784a-4fa5-885a-bfc77bd8ce47\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-8ce6350f-784a-4fa5-885a-bfc77bd8ce47')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-8ce6350f-784a-4fa5-885a-bfc77bd8ce47 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-8ce6350f-784a-4fa5-885a-bfc77bd8ce47');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-440abbdd-09f9-4dad-8a35-9582026d3e8d\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-440abbdd-09f9-4dad-8a35-9582026d3e8d')\"\n",
              "                title=\"Suggest charts\"\n",
              "                style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "        (() => {\n",
              "          let quickchartButtonEl =\n",
              "            document.querySelector('#df-440abbdd-09f9-4dad-8a35-9582026d3e8d button');\n",
              "          quickchartButtonEl.style.display =\n",
              "            google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "        })();\n",
              "      </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "IdNNvMzTvyyk",
        "outputId": "5b5b7b10-0c43-46ef-e6b5-6752d6a94aae",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 238
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              ...
              "    <tr>\n",
              "      <th>1</th>\n",
              "      <td>Medizintechnik Beratung</td>\n",
              "    </tr>\n",
              "    <tr>\n",
              "      <th>2</th>\n",
              "      <td>APL-ansvarig, samordning</td>\n",
              "    </tr>\n",
              "    <tr>\n",
              "      <th>3</th>\n",
              "      <td>Kaufmännischer Leiter</td>\n",
              "    </tr>\n",
              "    <tr>\n",
              "      <th>4</th>\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "0sIGZoBovwyd",
        "outputId": "cd568e05-9325-44e0-a0ec-5d76bda4afa9",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 238
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "7vPP7Ai0vuvI",
        "outputId": "722d65a2-9d22-4b40-d75b-c284c2cbbca3",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 238
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "aEtl3CJeyYW9",
        "outputId": "409f4008-93f0-4a6c-bbb1-e7a5d80fb5ae",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "l_ONWVUXyuuP",
        "outputId": "582ab731-89f3-4a02-acf2-6d7acf5f1db7",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "-APb1dT8y8Tf",
        "outputId": "3c433d16-167b-4e15-96b3-6b219b56e2ac",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "Vv-VFE6kzBo6",
        "outputId": "cf625fcf-ba3e-4b08-bcb5-9f31ecfaa7cf",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "MwdKwPZb6AkO",
        "outputId": "a6d2be97-fcb0-4582-f1c0-a2b0ab71e896"
      },
      "id": "MwdKwPZb6AkO",
      "execution_count": 36,
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              "        model      target  extension  accuracy  macro_f1\n",
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-f6c3bdc9-b097-4550-a14c-d28711fc8d2c\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-f6c3bdc9-b097-4550-a14c-d28711fc8d2c')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-f6c3bdc9-b097-4550-a14c-d28711fc8d2c button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-f6c3bdc9-b097-4550-a14c-d28711fc8d2c');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "    <div id=\"df-67aaded8-5384-407f-8f28-1ccba98f837c\">\n",
              "      <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-67aaded8-5384-407f-8f28-1ccba98f837c')\"\n",
              "                title=\"Suggest charts\"\n",
              "                style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "        (() => {\n",
              "          let quickchartButtonEl =\n",
              "            document.querySelector('#df-67aaded8-5384-407f-8f28-1ccba98f837c button');\n",
              "          quickchartButtonEl.style.display =\n",
              "            google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "        })();\n",
              "      </script>\n",
              "    </div>\n",
              "\n",
              "  <div id=\"id_9f9fb85e-629b-4565-8840-eb736100c131\">\n",
              "    <style>\n",
              "      .colab-df-generate {\n",
              "        background-color: #E8F0FE;\n",
              "        border: none;\n",
              ...
              "      }\n",
              "    </style>\n",
              "    <button class=\"colab-df-generate\" onclick=\"generateWithVariable('results_df_baseline')\"\n",
              ...
              "      (() => {\n",
              "      const buttonEl =\n",
              "        document.querySelector('#id_9f9fb85e-629b-4565-8840-eb736100c131 button.colab-df-generate');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      buttonEl.onclick = () => {\n",
              "        google.colab.notebook.generateWithVariable('results_df_baseline');\n",
              "      }\n",
              "      })();\n",
              "    </script>\n",
              "  </div>\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "variable_name": "results_df_baseline",
              "summary": "{\n  \"name\": \"results_df_baseline\",\n  \"rows\": 4,\n  \"fields\": [\n    {\n      \"column\": \"model\",\n      \"properties\": {\n        \"dtype\": \"category\",\n        \"num_unique_values\": 1,\n        \"samples\": [\n          \"Rule-based\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"target\",\n      \"properties\": {\n        \"dtype\": \"string\",\n        \"num_unique_values\": 2,\n        \"samples\": [\n          \"seniority\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"extension\",\n      \"properties\": {\n        \"dtype\": \"boolean\",\n        \"num_unique_values\": 2,\n        \"samples\": [\n          true\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"accuracy\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.20714945247381936,\n        \"min\": 0.13421052631578947,\n        \"max\": 0.6026315789473684,\n        \"num_unique_values\": 4,\n        \"samples\": [\n          0.4368421052631579\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"macro_f1\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.1941165105597117,\n        \"min\": 0.02639751552795031,\n        \"max\": 0.44918940911600075,\n        \"num_unique_values\": 4,\n        \"samples\": [\n          0.30458751010937224\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 36
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "MCLNfYq98Vm8",
        "outputId": "51821368-c20c-4454-ff1a-470ed8433f27"
      },
      "id": "MCLNfYq98Vm8",
      "execution_count": 38,
      "outputs": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "36r7Avly8evW",
        "outputId": "1667d066-e22b-4d8e-8d32-86d0647aa15b"
      },
      "id": "36r7Avly8evW",
      "execution_count": 39,
      "outputs": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "dlpWa50V8kFO",
        "outputId": "2390ad64-5630-474f-cae8-97a4d385c4c2"
      },
      "id": "dlpWa50V8kFO",
      "execution_count": 40,
      "outputs": [
